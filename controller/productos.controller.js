const { setQTYProductById, setQTYProductsById } = require("../services/productTam_service");
...
class Productos{
  ...
  static async getAllProducts(req, res) {
      try {   //console.log("--->>>",req);
        ...
        const response=await getAllProductViewResume({sucursalId:req.sucursal});
